...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Число " + ((compar(-5)) ? "положительное" : "отрицательное") + "!");
        System.out.println(hello("Bob"));
        System.out.println("Год високосный?" + leapYear(200));
    }
    ...
    public static float result(int a, int b, int c, int d){
        return a * (b + (c * 1.0f/ d)); //чтобы из инта получить флоут надо чтобы хоть одно число было флоут, например добавить 1
    }
    ...
    public static boolean aBoolean (int a, int b){ //boolean возвращает истину, если проверка прошла или ложь, если не прошла
        int sum = a +b;
    ...
    public static boolean compar (int a){
        return a >= 0;
    }
